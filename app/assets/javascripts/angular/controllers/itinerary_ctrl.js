...
gameControllers.controller('ItineraryCtrl', ['$scope', '$routeParams', '$window', 'gameProgress', 'drawProgressDots2',
  function($scope, $routeParams, win, gameProgress, drawProgressDots2) {
